...
class TestRequestGenerator(unittest.TestCase):
    ...
    def test_generate_single_request(self, mock_uniform, mock_random):
        """
    ...
    def test_no_request_generated(self, mock_random):
        """
    ...
    def test_rush_hour_uses_doubled_rate(self, mock_uniform, mock_random):
        """
    ...
    @patch("random.random", return_value=0.1)
    def test_multiple_calls_increment_id(self, mock_random):
        """
